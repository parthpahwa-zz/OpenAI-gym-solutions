...
class Player:
	def __init__(self):
		self.space_invader = Environment('SpaceInvaders-ram-v0')
		self.agent = Agent(self.space_invader.env.observation_space.shape[0], self.space_invader.env.action_space.n)
